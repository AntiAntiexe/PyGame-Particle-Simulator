...
while running:
    ...
    if (
        ...
        velocity1 = v1 - (2 * m2)/(m1 + m2) * (np.dot((v1 - v2), (pos_1[0] - pos_2[0])))/(((math.sqrt(pos_2[0]**2))**2) + ((math.sqrt(pos_1[0]**2))**2) - 2 * np.dot(pos_2[0], pos_1[0])) * (pos_1[0] - pos_2[0])
        velocity1 = v1 - (2 * m2) / (m1 + m2) * (np.dot((v1 - v2), (pos_1[0] - pos_2[0]))) / (((math.sqrt(pos_1[0] ** 2)) ** 2) + ((math.sqrt(pos_2[0] ** 2)) ** 2) - 2 * np.dot(pos_2[0],pos_1[0])) * (pos_1[0] - pos_2[0])"""
